...
{
    private readonly string filePath = $"{AppDomain.CurrentDomain.BaseDirectory}People.txt";
    ...
    private static List<Person> ParseData(IReadOnlyCollection<string> csvData)
    {
